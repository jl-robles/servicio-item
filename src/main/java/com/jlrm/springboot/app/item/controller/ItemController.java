package com.jlrm.springboot.app.item.controller;
...
import com.jlrm.springboot.app.item.models.service.IItemService;
...
public class ItemController {
	...
	@Autowired
	@Qualifier("feignService")	// @Qualifier("itemServiceRestTemplate")
	...
	public ResponseEntity<?> gfetConfig(@Value("${server.port}") String puerto) {
